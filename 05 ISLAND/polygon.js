class Polygon {
	constructor (from = {x: -0.5, y: -0.5, z: -0.5}, to = {x: 0.5, y: 0.5, z: 0.5},
		 sideColors = {front: [0, 0, 1, 1], right: [0, 1, 0, 1], back: [1, 0, 0, 1], left: [1, 1, 0, 1], bottom: [1, 0, 1, 1], top: [0, 1, 1, 1]}, polygonType) {
		this.from = from;
		this.to = to;
		...
		else if (polygonType == "palmenStamm"){
		this.MakePalm();
		}
		else if (polygonType == "palmenBlätter"){
		this.MakeLeafs();
		}
